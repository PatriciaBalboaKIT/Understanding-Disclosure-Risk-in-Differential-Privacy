...
data_file_1 = main_dir / "GRR" / "results" / "attack_results_Beijing.csv"
data_file_2 = main_dir / "SS" / "results" / "attack_results_Beijing.csv"
data_file_3 = main_dir / "UE" / "results" / "attack_results_oue_Beijing.csv"
...
plt.savefig("./DP_Audit/plots/LDP_attacks_beijing.png")
plt.show()