...
# === File paths ===
our_results_csv = "DP_Audit/SS/results/eps_estimation_Beijing.csv"        # your computed results
ldp_auditor_csv = "DP_Audit/LDP_Auditor/results/summary_Beijing.csv"  # LDP Auditor results
plot_path = "DP_Audit/SS/plots/EpsEstimation_Beijing.png"
...
df_comp_filtered = df_comp[df_comp["protocol"] == "SS"].sort_values(by="epsilon")
